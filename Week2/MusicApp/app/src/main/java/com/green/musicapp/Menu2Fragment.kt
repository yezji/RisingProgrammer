...
class Menu2Fragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        Toast.makeText(activity, "$TAG.onAttach()", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        val rootView:View = inflater.inflate(R.layout.fragment_menu2, container, false)
        return rootView
    }
...
/*    override fun onRestart() {
    ...
    override fun onStart() {
        ...
        Toast.makeText(activity, "$TAG.onStart()", Toast.LENGTH_SHORT).show()
    }

    override fun onResume() {
        super.onResume()
        // TODO : Activity와 마찬가지로 Fragment가 사용자와 상호작용을 하기 바로 직전에 호출
        Toast.makeText(activity, "$TAG.onResume()", Toast.LENGTH_SHORT).show()
    }

    override fun onPause() {
        super.onPause()
        // TODO : 다른 Fragment가 화면을 가리게 되어 기존 Fragment의 화면이 사라지게 되는 시점에서 호출, 기존 레이아웃은 백스택으로 들어감
        Toast.makeText(activity, "$TAG.onPause()", Toast.LENGTH_SHORT).show()
    }

    override fun onStop() {
        super.onStop()
        // TODO : Fragment가 화면에서 더 이상 보여지지 않게 되었을 때(기능을 완전히 상실했을 때) 호출
        Toast.makeText(activity, "$TAG.onStop()", Toast.LENGTH_SHORT).show()
    }

    override fun onDestroyView() {
        super.onDestroyView()
        // TODO : Fragment의 View들의 리소르를 해제
        Toast.makeText(activity, "$TAG.onDestroyView()", Toast.LENGTH_SHORT).show()
    }

    override fun onDestroy() {
        super.onDestroy()
        // TODO : Fragment가 완전히 소멸될 때 호출
        Toast.makeText(activity, "$TAG.onDestroy()", Toast.LENGTH_SHORT).show()
    }

    override fun onDetach() {
        super.onDetach()
        // TODO : Fragment가 Activity와 연결이 끊기기 직전에 호출
        Toast.makeText(activity, "$TAG.onDetach()", Toast.LENGTH_SHORT).show()
    }
}